  ...
  module Acts #:nodoc:
    module MuckYahooToken # :nodoc:
      ...
      module ClassMethods
        ...
        # +acts_as_muck_yahoo_token+
        def acts_as_muck_yahoo_token
          include ActiveRecord::Acts::MuckYahooToken::InstanceMethods
          extend ActiveRecord::Acts::MuckYahooToken::SingletonMethods
        end
